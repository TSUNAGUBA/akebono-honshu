...
- **現在ステータス:** Iteration 0〜3 完了済 + Iteration 4 段階 A (AWS RDS 接続) + 段階 B (Firebase Auth 切替) **完了 (2026-05-20)**。次は段階 C (本番デプロイ)
...
| 4 | 2-3 週間 | – | Hardening + **AWS インフラ構築 + Firebase 本番認証切替** + CI/CD + UAT 準備 (段階 A/B 完了 2026-05-20、段階 C/D 着手前) |
