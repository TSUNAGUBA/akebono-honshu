...
- **現在ステータス:** Iteration 計画策定済、Iteration 0 (基盤構築) 着手可
...
|---|---|---|---|
| 0 | 1-2 週間 | – | 基盤 (AWS インフラ / .NET 8 + Nuxt 4 スケルトン / CI/CD / docker-compose) |
| 1 | 2-3 週間 | 8 | 認証 (C-01〜03) + マスタ管理 (M-01〜05、共通テンプレート + 3 個別) |
| 2 | 2-3 週間 | 6 | 商品マスタ (P-01〜06、バルク登録 + サイズ展開 + 単価 + 一覧 + 詳細 + 画像) |
| 3 | 3 週間 | 7 | 発注書 (O-01〜07、Excel 出力含む、MVP のクリティカルパス) |
| 4 | 1-2 週間 | – | Hardening (統合テスト + 性能調整 + セキュリティ最終 + UAT 準備) |
