      ...
      <table class="w-full">
        <thead class="border-b border-gray-200 bg-gray-50">
          <tr>
            ...
            <th class="px-3 py-2 text-center text-xs font-semibold uppercase text-gray-600">素材発注</th>
            <th class="px-3 py-2 text-center text-xs font-semibold uppercase text-gray-600">生産指示</th>
            <th class="px-3 py-2 text-center text-xs font-semibold uppercase text-gray-600">BOM</th>
            <th class="px-3 py-2 text-left text-xs font-semibold uppercase text-gray-600">手配</th>
          </tr>
        </thead>
        <tbody>
          ...
          <tr v-for="r in rows" :key="r.familyId" class="border-b border-gray-100 last:border-0 hover:bg-blue-50">
            ...
            <td class="px-3 py-2 text-sm">{{ r.productName }}</td>
