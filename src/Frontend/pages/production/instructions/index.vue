...
<template>
  <main class="mx-auto max-w-7xl px-4 py-8">
    ...
    <div class="mb-3 flex items-center gap-4">
      <input v-model="search" type="search" placeholder="指示番号 / 品番 / 品名 / 加工先で検索" class="w-80 rounded-md border border-gray-300 px-3 py-1.5 text-sm focus:border-blue-500 focus:outline-none" />
