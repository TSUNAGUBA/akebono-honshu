...
<template>
  <div ref="wrapperRef" class="relative">
    <input
      ...
      :disabled="disabled"
      class="w-full rounded-md border border-gray-300 px-3 py-2 pr-8 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 disabled:bg-gray-50 disabled:text-gray-400"
      :class="inputClass"
      autocomplete="off"
      @input="onInput"
      @focus="onFocus"
