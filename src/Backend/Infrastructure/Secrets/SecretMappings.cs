...
///
/// **新規 Secret を追加する場合の 3 ステップ (CLAUDE.md 原則 5 / 6 整合、CR-m4 / SA-P2-3 指摘):**
...
/// 3. (オペレーター) 本番 Secrets Manager に `&lt;prefix&gt;/&lt;SecretName&gt;` を投入
///
/// **typo / ドリフト検知 (SA-P1-4):**
...
/// 利用側で `null` 引きに化けるため遠い失敗になりやすい。
/// migration-plan §4.2.2 のオペレーター手順に「`aws secretsmanager list-secrets` の出力と
/// 本テーブルの `SecretName` 列を目視突合」を含めて多重防御する。
/// </summary>
